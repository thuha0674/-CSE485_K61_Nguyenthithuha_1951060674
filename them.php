...
<?php
    ...
    if(isset($_POST['them'])){
        ...
        include "connect.php";
        //b2:truy vấn
        $sql="INSERT INTO exams(id, exam_tittle, exam_datetime, duration, total_question, marks_per_rigth_answer, created_on, status, exam_code)
             VALUES ('$id','$exam_name','$exam_datetime','$duration','$total_question','$marks_per_right_answer','$created_on','$status','$exam_code')";
    ...
    <main>
        <form method="POST" action="">
            <div class="container">  
                ...
                <div class="col-md-6">
                    <div class="col-sm-10">
                        <button type="submit" class="btn btn-success" id="them" name="them">Thêm bài</button>
                    </div>
                </div>
